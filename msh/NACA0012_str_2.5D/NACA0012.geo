...
Transfinite Line{lnn} = transVert Using Progression prog; // 0.78
Transfinite Line{lee} = transVert Using Progression prog;
Transfinite Line{lww} = transVert Using Progression prog;
Transfinite Line{lss} = transVert Using Progression prog;
