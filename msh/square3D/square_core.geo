...
outa[] = Extrude {0,0,depth} {Surface{1}; Layers{1}; Recombine;};
outb[] = Extrude {0,0,depth} {Surface{2}; Layers{1}; Recombine;};
outc[] = Extrude {0,0,depth} {Surface{3}; Layers{1}; Recombine;};
outd[] = Extrude {0,0,depth} {Surface{4}; Layers{1}; Recombine;};
